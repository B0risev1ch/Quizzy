...
namespace Final
{
    internal class App
    {
	    private const int ApiId = 23490736;
	    private const string ApiHash = "d36cd7b0cd37c18ae495ca17f1a7ff2c";

	    // PhoneNumber must contain international phone with (+) prefix.
	    // For example +16171234567
	    private const string PhoneNumber = "+79088953777";
        ...
        private static async Task<TdApi.User> GetUser()
        {
	        return await _client.ExecuteAsync(new TdApi.GetUser());
        }
